...
void Sculptor::setColor(float r_, float g_, float b_, float alpha) // define a cor e transparência de cada voxel
{
...
void Sculptor::writeOFF(char *filename)
{
  ...
  ofstream endArq; //Responsavel por criar o arquivo
  endArq.open(filename); //Cria o arquivo com o nome recebido
