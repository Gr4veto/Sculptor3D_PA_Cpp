...
int main(void){
    ...
    figs = it.analise("C:/Users/wesle/Downloads/agr/arquivo.txt"); /* it.analise retorna um vetor para a classe figura geometrica,
    ...
    figura->writeOFF("C:/Users/wesle/Downloads/agr/caveira.off"); // faz a escrita do arquivo off
